...
class MainDashboard extends StatelessWidget {
  ...
  const MainDashboard({super.key, this.initialTabIndex = 0}); // default 0
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.selectedMenu != initialTabIndex) {
      controller.selectedMenu = initialTabIndex;
    }
    ...
    return GetBuilder<DashboardController>(
      builder: (controller) {
        return Scaffold(
            ...
            actions: [
              user.userType == 'DONOR'
                  ? IconButton(
                      ...
                      tooltip: user.isAvailable ?? false
          ...
          body: (controller.selectedMenu == 0)
              ? Homescreen()
